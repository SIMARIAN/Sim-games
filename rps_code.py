...
p1.title("rock paper scissor game")
...
Label(p1,text = "ROCK PAPER SCISSOR",font = "georgia 38 bold underline",bg='#80f422',fg = "black").pack(pady = 20)
frame2 = Frame(p1,bg='#80f422')
frame2.pack()
l1 = Label(frame2,text = "Player",font=("arial",20),bg="#80f422")
l2 = Label(frame2,text = "VS",font=("arial",20),bg="#80f422")
l3 = Label(frame2, text = "Computer",font=("arial",20),bg="#80f422")
l1.pack()
l2.pack()
l3.pack()
l4 = Label(p1,text = "",font = "normal 20 bold",bg = "white",width = 15 ,borderwidth = 2,relief = "solid")
l4.pack(pady = 20)
frame1 = Frame(p1,bg='#80f422')
frame1.pack()
b1 = Button(frame1, text = "Rock",bg="aqua",fg="black",font=("arial",20), width = 7,command = isrock)
b2 = Button(frame1, text = "Paper ",bg="aqua",fg="black",font=("arial",20), width = 7,command = ispaper)
b3 = Button(frame1, text = "Scissor",bg="aqua",fg="black",font=("arial",20), width = 7,command = isscissor)
